                    ...
                    <div className="horizontal-flex gap-2 w-full">
                        ...
                        <div className="flex flex-col flex-1 overflow-hidden">
                            ...
                            <p className="text-sm break-words">
                                ...
                                {translations.tool?.wellbeing_explaination || "For now, the Mood Insight tool is live. You can set your mood daily, with mood prompts appearing at three key points throughout the day: 6AM–12PM, 12PM–6PM, 6PM–12AM"}<br /><br />
